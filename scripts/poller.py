#!/usr/bin/env python3
"""Checks whether now matches a scheduled Dreis slot and, if so,
...
def handle_partial_failure(post, plan, plan_path, now, slot_label, exc):
    ...
    notify_once(
        ...
        "novo automaticamente. Confira manualmente no Facebook/Instagram da Dreis o que realmente foi "
...
def handle_story(post):
    ...
    if item["type"] == "image":
        ...
        folder_id = os.environ.get("DREIS_STORIES_DRIVE_FOLDER_ID", "1rBwVvcmUZTDMjU3C1WcUR8sbtaqIG8s9")
